...
Route::controller(CartController::class)->group(function () {
    ...
    Route::post('/product/{productId}/store', 'store')->name('product.store.cart')->middleware('auth');
...
Route::controller(ProductController::class)->group(function () {
    ...
    // Route::post('/product/{productId}/store/cart', 'storeProductInCart')->name('product.store.cart')->middleware('auth');
...
Route::controller(ProductImagesController::class)->group(function () {
    ...
    Route::post('/product/store/images', 'storeImages')->name('product.store.images')->middleware('auth');
