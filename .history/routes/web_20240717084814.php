...
Route::controller(NewsController::class)->group(function () {
    ...
    Route::get('/news/create', 'create')->name('news.create')->middleware('checkrole:admin,sales');
    Route::post('/news/store', 'store')->name('news.store')->middleware('checkrole:admin');
    // Route::get('/news/{id}', 'show')->name('news.show');
    Route::get('/news/{news}/edit', 'edit')->name('news.edit')->middleware('checkrole:admin');
    Route::put('/news/{id}', 'update')->name('news.update')->middleware('checkrole:admin');
    Route::delete('/news/{id}/delete', 'delete')->name('news.delete')->middleware('checkrole:admin');
});