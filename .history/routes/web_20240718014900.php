...
Route::prefix('tag')->controller(TagController::class)->group(function () {
    ...
    Route::get('/{news}/edit', 'edit')->name('tag.edit')->middleware('checkrole:admin');
    Route::put('/{newsId}', 'update')->name('tag.update')->middleware('checkrole:admin');
    Route::delete('/{newsId}/delete', 'delete')->name('news.delete')->middleware('checkrole:admin');
});