...
Route::prefix('tag')->controller(TagController::class)->group(function () {
    ...
    Route::get('/{news}/edit', 'edit')->name('news.edit')->middleware('checkrole:admin,salesman');
    Route::put('/{newsId}', 'update')->name('news.update')->middleware('checkrole:admin,salesman');
    Route::delete('/{newsId}/delete', 'delete')->name('news.delete')->middleware('checkrole:admin,salesman');
});