...
Route::controller(CartController::class)->group(function () {
    ...
    // Route::put('/cart/update-quantities', 'updateQuantities')->name('cart.quantities.update');
    Route::put('/cart/update-quantities', 'updateQuantity')->name('cart.quantity.update')->middleware('auth');
