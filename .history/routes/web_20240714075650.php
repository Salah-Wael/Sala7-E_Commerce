...
Route::get('/panels', 'notifications')->name('admin.panel.notifications');
Route::get('/panels', 'sweetalert')->name('admin.panel.sweetalert');
Route::get('/font-awesome-icons', 'font-awesome-icons')->name('admin.panel.font-awesome-icons');
