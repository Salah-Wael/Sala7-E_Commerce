...
Route::controller(CartController::class)->group(function () {
    Route::get('/cart/{id}', 'show')->name('cart.show')->middleware('auth');
    Route::post('/cart/store/{id}', 'store')->name('cart.store')->middleware('auth');
    Route::delete('/product/{id}/delete', 'deleteFromCart')->name('product.delete')->middleware('auth');
});
