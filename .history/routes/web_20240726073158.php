...
Route::controller(CartController::class)->group(function () {
    ...
    Route::ger('/cart/update-quantities', 'updateQuantities')->name('cart.quantities.update')->middleware('auth');
...
Route::prefix('category')->controller(CategoryController::class)->group(function () {
    ...
    Route::get('/create', 'create')->name('category.create')                  ->middleware('checkrole:admin,salesman');
    Route::post('/store', 'store')->name('category.store')                    ->middleware('checkrole:admin,salesman');
    Route::get('/{category}/edit', 'edit')->name('category.edit')             ->middleware('checkrole:admin');
    Route::put('/{categoryName}', 'update')->name('category.update')          ->middleware('checkrole:admin');
    Route::delete('/{categoryName}/delete', 'delete')->name('category.delete')->middleware('checkrole:admin');
});
...
Route::prefix('test')->controller(TestController::class)->group(function () {
    Route::get('/offers', 'offers')->name('test.offers')->middleware('checkrole:admin');
});

Route::prefix('paypal')->controller(PaypalController::class)->group(function () {
    Route::get('/payment', 'payment')->name('paypal.payment');
