...
Route::get('/charts/charts', 'charts')->name('admin.panel.charts')->middleware('checkrole:admin')->middleware('checkrole:admin');
Route::get('/charts/sparkline', 'sparkLine')->name('admin.panel.sparklin->mi->middleware('checkrole:admin');dleware('checkrole:admin');')->middleware('checkrole:admin');
