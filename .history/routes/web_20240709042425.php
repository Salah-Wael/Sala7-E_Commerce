...
Route::get('/orders', function () {
    $orderRecipients = OrderRecipient::with('orders')->with('product')->get();
    $orderRecipients->orders->with('product');
    dd($orderRecipients);
    return view('orders')->with(['orderRecipients' => $orderRecipients]);
})->name('orders');

// ('/orders', function () {
//     $orderDetails = OrderDetail::with('recipient')->with('product')->get();
//     dd($orderDetails);
