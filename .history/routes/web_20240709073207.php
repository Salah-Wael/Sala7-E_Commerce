...
Route::get('/orders', function () {
    ...
    $subTotalPrice = new Collection();
    foreach ($orderRecipients->orders as $recipient) {
        $subTotalPrice = PriceController::subTotal($recipient->orders);
        $subTotalPriceOfAllOrders = $subTotalPrice->merge($recipient->orders);
    };
    dd($subTotalPriceOfAllOrders);
    // dd($subTotalPrice);
