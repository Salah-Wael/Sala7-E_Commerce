                                ...
                                @endphp
                                    <tr class="table-body-row">
                                        ...
                                        <td class="product-quantity">
                                            <form action="{{ route('cart.quantity.update', $product->image_path) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                                <input type="number" name="quantity" min="{{ $product->quantity }}" step="{{ $product->quantity }}" placeholder="{{ $cart->quantity }}">
                                            </form>
                                        </td>
