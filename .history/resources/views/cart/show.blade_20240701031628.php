                                ...
                                <tbody>
                                    @forelse ($carts as $cart)
                                        <tr class="table-body-row">
                                            ...
                                            <td class="product-image"><img src="{{ asset('assets/img/products/'.$cart->image_path) }}" alt=""></td>
                                            <td class="product-name">{{ $cart->name }}</td>
                                            <td class="product-price">{{ $cart->price }}</td>
                                            <td class="product-quantity">
                                                <input type="number" name="quantities[{{ $cart->product_id }}]" min="1" max="{{ $cart->max_quantity }}" value="{{ $cart->quantity }}">
                                            </td>
