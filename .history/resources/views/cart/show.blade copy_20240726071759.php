                            ...
                            <tbody>
                                ...
                                <tr class="table-body-row">
                                    <td class="product-remove">
                                        <a href="{{ route('cart.delete', $product->id) }}" onclick="event.preventDefault();
                                                document.getElementById('delete-product-{{ $product->id }}-from-cart').submit();">
                                            <i class="far fa-window-close"></i>
                                        </a>
                                        <form id="delete-product-{{ $product->id }}-from-cart" action="{{ route('cart.delete', $product->id) }}" method="POST" class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
...
<div class="col-lg-4">
    <div class="total-section">
        ...
        <div class="cart-buttons">
            <a href="{{ route('cart.quantities.update') }}" class="boxed-btn" onclick="event.preventDefault();
