                            ...
                            <tbody>
                                ...
                                @endphp
                                    <tr class="table-body-row">
                                        ...
                                        <form id="delete-form-{{ <form id="delete-form" action="{{-- route('cart.delete', $product->id) --}}" method="POST" class="d-none">
                                    @csrf
                                    @method('delete')
                                    </form> }}" action="{{ route('cart.delete', $product->id) }}" method="POST" class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
