                        ...
                        <nav class="main-menu">
                            <ul>
                                ...
                                @if (Auth::user() && Auth::user()->role == 'admin')
                                    ...
                                    <li><a href="#">Test</a>
                                        <ul class="sub-menu">
                                            <li><a href="{{ route('test.offers') }}">Create Product</a></li>
                                        </ul>
                                    </li>
                                @endif
                                ...
                                @if (Auth::check())
                                    <li><a href="shop.html">{{ __('messages.Shop') }}</a>
                                        <ul class="sub-menu">
                    ...
                    <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
                        <div class="hero-text">
                            <div class="hero-text-tablecell">
                                ...
                                <div class="hero-btns">
                                    <a href="{{ route('product.category.show', $category->name) }}" class="boxed-btn">Fruit Collection</a>
