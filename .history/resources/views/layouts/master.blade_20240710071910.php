                            ...
                            <ul>
                                ...
                                @guest
                                    <li>
                                        <a href="#">Language</a>
                                        <ul class="sub-menu">
                                            <a href="{{ route('language.change') }}"
                                            onclick="event.preventDefault();
                                            document.getElementById('ar-language', 'ar').submit();">
                                                {{ __('عربي') }}
                                            </a>
                                            <form id="ar-language" action="{{ route('language.change') }}" method="POST" class="d-none">
                                                @csrf
                                            </form>
                                            <li><a href="{{ route('product.create', 'ar') }}">عربي</a></li>
                                            <li><a href="{{ route('product.table', 'en') }}">English</a></li>
                                        </ul>
                                    </li>
