                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        document.getElementById('ar-language').submit();">
                                            {{ __('عربي') }}
                                        </a>
                                        <form id="ar-language" action="{{ route('language.change', 'ar') }}" method="POST" class="d-none">
                                            @csrf
                                        </form>
                                        <a href="{{ route('language.change', 'en') }}"
                                        onclick="event.preventDefault();
                                        document.getElementById('en-language').submit();">
                                            {{ __('English') }}
                                        </a>
                                        <form id="en-language" action="{{ route('language.change', 'en') }}" method="POST" class="d-none">
                                            @csrf
                                        </form>
                                    </ul>
                                </li>
