                            ...
                            <ul>
                                ...
                                <li><a href="shop.html">Shop</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="checkout.html">Check Out</a></li>
                                        @if (Auth::check())
                                            <li><a href="{{ route('cart.show', Auth::user()->id ) }}">Cart</a></li>
                                        @endif
                                    </ul>
                                </li>
                                @guest
                                ...
                                @endguest
                                    ...
                                    <?php $productsCountInCart = DB::table('carts')->where('user_id', Auth::user()->id)->count() 
                                <li>
                                    <div class="header-icons">
                                        @if (Auth::check())
                                            <span class="shopping-cart-items-count">{{ $productsCountInCart }}</span>
