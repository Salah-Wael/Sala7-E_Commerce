                                ...
                                <div class="card-header" id="heading{{ $recipient->id }}">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link" type="button" data-toggle="collapse"
                                            data-target="#collapse{{ $recipient->id }}" aria-expanded="true" aria-controls="collapse{{ $recipient->id }}">
                                            Order Details ({{ $recipient->name. " created at ". $recipient->created_at}})
                                        </button>
                                    </h5>
                                </div>

                                <div id="collapse{{ $recipient->id }}" class="collapse show" aria-labelledby="heading{{ $recipient->id }}"
