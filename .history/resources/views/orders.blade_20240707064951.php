                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        <div class="billing-address-form">
                                            ...
                                            @csrf
                                                <p><input type="text" name="name" value="{{ $order->recipient-> }}" readonly></p>
                                                <p><input type="email" name="email" value="{{ $order->recipient-> }}" readonly></p>
                                                <p><input type="text" name="address" value="{{ $order->recipient-> }}" readonly></p>
                                                <p><input type="tel" name="phone" value="{{ $order->recipient-> }}" readonly></p>
                                                <p>
                                                ...
                                                <p>
                                                    <textarea name="comment" cols="30" rows="10" readonly></textarea>
                                                </p>
                                            </form>
                                        </div>
                                    </div>
