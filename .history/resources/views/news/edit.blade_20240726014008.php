				...
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="contact-form">
                        ...
                        @csrf
                            ...
                            <p>
                                <textarea name="content" cols="30" rows="10" placeholder="Description">{{$news->content}}{{ old('content')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select class="col-md-6 form-control" id="categoryTag" name="tags[]">
