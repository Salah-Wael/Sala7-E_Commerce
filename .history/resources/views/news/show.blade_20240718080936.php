				...
				<div class="col-lg-8">
					<div class="single-article-section">
						<div class="single-article-text">
							<div >
                                <img
                                style="min-height: 450px; max-height: 450px; border-radius: 10px;"
                                src="{{ asset('assets/img/news/'.$news->image) }}" alt="{{ $news->title }}"
                                >
                            </div>
							<p class="blog-meta">
								<span class="author"><i class="fas fa-user"></i> {{ $news->role }}</span>
                            ...
                            <div class="recent-posts">
                                ...
                                <ul>
                                    @foreach ($relatedNews as $post)
                                        <li><a href="{{ route('news.show', $post->id) }}">You will vainly look for fruit on it in autumn.</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        @endif
