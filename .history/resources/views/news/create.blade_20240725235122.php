                            ...
                            {{-- <div class="form-group">
                                ...
                                {{-- @empty --}}
                                    {{-- <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="col-md-6 form-control" id="categoryTag" value="{{ old('tags') }}" name="tags[]">
                                                @forelse ($categoryTags as $categoryTag)
                                                <option value="{{ $categoryTag->id }}">{{ $categoryTag->tag }}</option>
                                                @empty
                            ...
                            <div class="col-md-6">
                                @forelse ($categoryTags as $categoryTag)
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tags" id="categoryTag{{ $categoryTag->id }}" value="{{ $categoryTag->id }}">
                                        <label class="form-check-label" for="categoryTag{{ $categoryTag->id }}">
                                            {{ $categoryTag->tag }}
                                        </label>
                                    </div>
                                @empty
                                    <p>No category tags available</p>
                                @endforelse
                            </div>
                        </div>
                                {{-- @endforelse --}}
