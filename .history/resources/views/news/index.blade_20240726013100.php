                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-latest-news">
                            ...
                            @if (Auth::check() && Auth::user()->role == 'admin')
                                <a href="{{ route('product.edit', $post->id) }}" class="cart-btn"><i class="fas fa-edit"></i> Edit</a>
                                ...
                                <form id="delete-form" action="{{ route('product.delete', $post->id) }}" method="POST" class="d-none">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            @endif
