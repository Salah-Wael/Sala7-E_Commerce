                                        ...
                                        <table class="cart-table">
                                            ...
                                            <tbody>
                                                <tr class="table-body-row">
                                                    ...
                                                    <td class="product-image"><center><img src= "{{ asset('assets/img/products/'.$order->product->image_path) }}" alt="{{ $order->product->name }}"></center></td>
                                                    ...
                                                    <td class="product-total"></center>{{ $order->price*$order->quantity }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    @empty
