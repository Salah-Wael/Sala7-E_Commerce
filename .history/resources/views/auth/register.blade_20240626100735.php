        ...
        @csrf
            ...
            <div class="input-group">
                ...
                <div class="input-field radio-group">
                    ...
                    <input class="input-box" type="radio" id="male" class="radio-input" name="gender" value="male" required>
                    <label for="male" class="radio-label">Male</label>
                    <input class="input-box" type="radio" id="female" class="radio-input" name="gender" value="female" required>
