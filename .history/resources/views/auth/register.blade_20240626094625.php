    ...
    <div class="box">
        ...
        @csrf
            ...
            <div class="input-group">
                ...
                <div class="input-field">
                    <label class="input-box" for="birthDate">Bith Date</label>
                    <input type="date" class="input-box" value="{{ old('birthDate') }}"  id="birthDate" name="birthDate" required>
                </div>
                <br>
                <div class="input-field radio-group">
                    <label for="gender">Gender:</label>
                    <input type="radio" id="male" class="radio-input" name="gender" value="male" required>
                    <label for="male" class="radio-label">Male</label>
                    <input type="radio" id="female" class="radio-input" name="gender" value="female" required>
    ...
    <div class="box-register" id="register">
        ...
        {{-- @csrf --}}
            ...
            <div class="input-group">
                ...
                @endif
                <div class="input-field">
                    <input type="password" class="input-box" name='password_confirmation' id="regPassword" required>
