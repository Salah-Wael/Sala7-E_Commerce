 ...
 <div class="container">
    <div class="box">
     ...
     <div class="box-register" id="register">
        ...
        <div class="input-group">
            <div class="input-field">
                <input type="text" name='firstName' value="{{ old('firstName') }}" class="input-box" id="regUser" required>
                <label for="regUser">Username</label>
            </div>
            <div class="form-group">
            <label class="form-label" for="exampleInputName1">First name</label>
            <input type="text"   required id="exampleInputName1" placeholder="First name">
        </div>
