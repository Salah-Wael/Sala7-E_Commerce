                        ...
                        <table class="order-details">
                                ...
                                @foreach ($productsInCart as $cart)
                                    <tr>
                                        <td class="product-image">
                                            @if (is_object($cart) && property_exists($cart, 'image_path'))
                                                <img src="{{ asset('assets/img/products/' . $cart->image_path) }}" alt="Product Image">
                                                <img
                            ...
                            <tbody class="checkout-details">
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <center>{{ $productsInCart->subTotalPrice }}</center>
                                    </td>
                                </tr>
                                <tr>
