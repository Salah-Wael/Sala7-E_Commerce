                            ...
                            <table class="cart-table">
                                ...
                                <tbody>
                                    <tr class="table-body-row">
                                        ...
                                        <td class="product-image"><img src= "{{ asset('assets/img/products/'.$order->product->image_path) }}" alt="{{ $order->product->name }}"></td>
                                        ...
                                        <td class="product-quantity">
                                            <input type="number" name="quantities[{{ $cart->product_id }}]" value="{{ $order->quantity }}" readonly>
                                        </td>
                        ...
                        <table class="order-details">
                            ...
                            <tbody class="order-details-body">
                                @foreach ($productsInCart as $cart)
                                    <tr>
                                        <td class="product-image"><img src= "{{ asset('assets/img/products/'.$order->product->image_path) }}" alt="{{ $cart->name }}"></td>
                                        <td>{{ $order->product->name }}</td>
                                        <td>{{ $order->quantity }}</td>
                                        <td>{{$order->quantity * $cart->price }}</td>
                                    </tr>
                                @endforeach
