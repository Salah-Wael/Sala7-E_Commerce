...
@section('content')
    ...
    <div class="product-section mt-150 mb-150">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            <a href="{{ route('product.index') }}"><li class="active">All</li></a>
                            @forelse ($categories as $category)
                                <a href="{{ route('product.category.show', $category->name) }}"><li >{{ $category->name }}</li></a>
                            @empty
                                No categories
                            @endforelse
                        </ul>
        ...
        <!-- features list section -->
            <div class="list-section mt-60 pt-80 pb-80">
                <div class="container">
