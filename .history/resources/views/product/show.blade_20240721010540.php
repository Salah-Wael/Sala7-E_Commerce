			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="single-product-content">
                        <p class="single-product-pricing"><span>{{ $product->name }}</span></p>
                            ...
                            <div class="col-lg-4 col-md-6 text-center">
                                <div class="single-product-item">
                                    <div class="product-image">
                                        <a href="{{ route('product.show', $item->id) }}"><img src="{{ asset('assets/img/products/'.$item->image_path) }}" alt=""></a>
                                    </div>
                                    <h3>{{ $item->name }}</h3>
                                    ...
                                    <p class="product-price">
                                        ...
                                        @endif
                                        @if($item->category_name == 'fruits' || $item->category_name == 'vegetables')
                                            <h3>{{"Price: ". $item->price ." "}}<span class="orange-text">Per {{ $item->quantity ." "}}</span> Kg</h3>
                                        @else
                                            <h3>Price: <span class="orange-text">{{ $item->price }}</span> For<span class="orange-text"> {{ $product->quantity ." "}}</span></h3>
                                        @endif
                                    </p>
