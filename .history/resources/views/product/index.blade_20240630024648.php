                ...
                @forelse ($products as $product)
                    <div class="col-lg-4 col-md-6 text-center {{ str_replace(' ', '', $product->category_name) }}">
                        <div class="single-product-item">
                            ...
                            <li >
                                <a href="{{ route('product.edit', $product->id) }}" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"> class="cart-btn"><i class="fas fa-edit"></i> {{ __('Logout') }}</a>
                                <a href="{{ route('logout') }}"
