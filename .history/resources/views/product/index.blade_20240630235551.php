                    ...
                    <div class="col-lg-4 col-md-6 text-center {{ str_replace(' ', '', $product->category_name) }}">
                        <div class="single-product-item">
                            ...
                            <a href="{{ route('cart.store', $product->id) }}" 
                                ...
                                document.getElementById('add-product-to-cart').submit();" class="cart-btn">
                                <i class="fas fa-shopping-cart"></i>
                                {{ __('Add to Cart') }}
                            </a>
                            {{-- <form id="add-product-to-cart" action="{{ route('cart.store', $product->id) }}" method="POST" class="d-none">
                                @csrf
                            </form> --}}
