                ...
                @forelse ($products as $product)
                    <div class="col-lg-4 col-md-6 text-center {{ str_replace(' ', '', $product->category_name) }}">
                        <div class="single-product-item">
                            ...
                            <a href="{{ route('cart') }}" class="cart-btn"><i class=" fa-shopping-cart"></i> Add to Cart</a>
                            <a href="{{ route('product.edit', $product->id) }}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Edit</a>
