					...
					<div class="row">
                        <div class="col-lg-8 offset-lg-2 text-center">
                            <div class="section-title">	
                                <h3><span class="orange-text">Add new</span> Product</h3>
                            </div>
                        </div>
                    </div>
				</div>
			...
			<div class="row">
				<div class="col-lg-8 mb-5 mb-lg-0">
					...
					<div class="contact-form">
                        ...
                        @csrf
							<p>
								<input style="width: 100%;" type="text" placeholder="Product Name" name="name" value="{{ old('name')}}">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="contact-form" type="file" name="image_path" value="{{ old('image_path')}}" id="main" accept=".jpeg, .jpg, .png, .jfif, .svg">
                            </div>
