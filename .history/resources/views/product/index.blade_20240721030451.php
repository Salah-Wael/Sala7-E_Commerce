            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            <a href="{{ route('product.index') }}"><li class="{{ request()->is('products') ? 'active' : '' }}">{{ __('messages.All') }}</li></a>
                            @forelse ($categories as $category)
                                <a href="{{ route('product.category.show', $category->name) }}"><li class="{{ request()->is($category->name.'/products') ? 'active' : '' }}">{{ $category->name }}</li></a>
                            @empty
                                No categories
                            @endforelse
                        </ul>
