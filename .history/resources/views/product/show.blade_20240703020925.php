					...
					<div class="single-product-content">
						...
						<div class="single-product-form">
							<form action="index.html">
                                ...
                                <input type="number" name="quantities[{{ $product->id }}]" min="{{ $product->quantity }}" step="{{ $product->quantity }}" value="{{ if($productCart)$productCart->quantity@else $product->quantity@endif }}">
							</form>
							<a href="{{ route('cart.show', Auth::user()->id ) }}" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
