                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <a href="{{ route('product.category.show', $category->name) }}"><li class="active" data-filter="*">All</li></a>

                            @forelse ($categories as $category)
                                <a href="{{ route('product.category.show', $category->name) }}"><li data-filter=".{{ str_replace(' ', '', $category->name) }}">{{ $category->name }}</li></a>
                            @empty
                                No categories
                            @endforelse
                        </ul>
