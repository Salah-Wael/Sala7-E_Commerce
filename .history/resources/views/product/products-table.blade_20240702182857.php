                        ...
                        <table id="products" class="cart-table display">
                            ...
                            <tbody>
                                ...
                                <tr class="table-body-row">
                                    ...
                                    @if (Auth::check() && Auth::user()->role == 'admin')
                                        <td >
                                            <a href="{{ route('product.edit', $product->id) }}" class="cart-btn"><i class="fas fa-imag"></i> Edit</a>
                                            <a href="{{ route('product.show.images', $product->id) }}" class="cart-btn"><i class="fas fa-edit"></i> Images</a>
