...
{
    public static function cartTotalPrice($carts)
    {
        $totalPrice = 0;
    ...
    public function show($userId)
    {
        if (Auth::user()->id == $userId) {
            ...
            $totalPrice = CartController::cartSubTotalPrice($carts);

            return view('cart.show', compact('productsCart', 'carts', 'totalPrice'));
        } else {
