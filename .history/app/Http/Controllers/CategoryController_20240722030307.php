    ...
    public function update(Request $request, $id)
    {
        ...
        if ($category) {
            ...
            if ($request->hasFile('image_path')) {
                ImageController::deleteImage($request->image_path, 'assets/img/categories/');
                $category->image_path = ImageController::storeImage($request, 'image_path', 'assets/img/products/');
            }
