...
class ProductController extends Controller
{
    ...
    public function show($productId)
    {
        ...
        $productImages = DB::table('product_images')->where('product_id', $productId)->limit(10)->get();
    ...
    public function getProductsByCategory(String $category){
        $categories = DB::table('categories')->where('name', $category)->get();
        $products = Product::where('category_name', $category)->orderby('created_at', 'desc')->paginate(50);
        // $products = DB::table('products')->where('category_name', $category)->get();
